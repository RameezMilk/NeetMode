...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .durations{display:grid;grid-template-columns:repeat(1,1fr);gap:14px;margin-bottom:22px}
  .durations button{
  ...
  <div class="panel">
    ...
    <div class="frame">
      ...
      <div class="durations" id="durations">
        <button class="sel" data-min="30"><b>30</b><span>MIN</span></button>
      </div>

      <button id="start"><span class="play">▶</span>INITIATE FOCUS</button>
      <p id="status"></p>
